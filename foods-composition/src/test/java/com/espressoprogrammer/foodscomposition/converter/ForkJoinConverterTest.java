...
import static com.espressoprogrammer.foodscomposition.converter.ForkJoinConverter.THRESHOLD;
...
public class ForkJoinConverterTest {
    ...
    public void computeWithEmptyList() {
        assertThat(FORK_JOIN_POOL.invoke(new ForkJoinConverter<>(new ArrayList<>(), converter))).isEmpty();
    }
    ...
    public void computeWithValuesCountLessThanThreshold() {
        ...
        assertThat(FORK_JOIN_POOL.invoke(new ForkJoinConverter<>(values, converter)))
