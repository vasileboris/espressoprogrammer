...
import static com.espressoprogrammer.foodscomposition.converter.OptimisedForkJoinConverter.THRESHOLD;
...
public class OptimisedForkJoinConverterTest {

    @Test
    public void computeWithEmptyList() {
        assertThat(FORK_JOIN_POOL.invoke(new OptimisedForkJoinConverter<>(new ArrayList<>(), converter))).isEmpty();
    }
    ...
    public void computeWithValuesCountLessThanThreshold() {
        ...
        assertThat(FORK_JOIN_POOL.invoke(new OptimisedForkJoinConverter<>(values, converter)))
